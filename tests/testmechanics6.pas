...
procedure TestMechanics6();
   ...
   begin
      ...
      RunCommand('put bag in stairwell', ['(first taking the bag of holding)', 'Taken.', 'It is not clear how to get inside the stairs.']);
      RunCommand('put bag on stairs', ['Placed on the stairs.']);
      RunCommand('move me to stairs', ['(on the stairs)', 'On the stairs (between the Bottom room and the Top room)', 'The stairs have steps.', 'The stairs are between the Bottom room and the Top room.', 'There is a bag of holding here.']);
      ...
      RunCommand('push bag into opening', ['(on the stairs)', 'The bag of holding is already on the stairs.']);
      RunCommand('take bag', ['Taken.']);
      RunCommand('push bag into opening', ['(on the stairs)', 'Placed on the stairs.']);
      ...
      RunCommand('up', ['Top Room', 'This is the room at the top of the stairs. Stairs lead down to the Bottom room.', 'There is a big block here.']);
      RunCommand('put bag in opening', ['Placed on the stairs.']);
      RunCommand('find bag', ['The bag of holding is on the stairs.']);
      ...
      RunCommand('push block into opening', ['(on the stairs)', 'Pushed.']);
